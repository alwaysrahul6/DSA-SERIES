...
// Solution
    public static ArrayList<Integer> topoSort(int V, int[][] edges) {
        ...
        ArrayList<ArrayList<Integer>> adj = adjFacde(V, edges);
...
///     Store The Result
    ...
    private static void dfs(int node, ArrayList<ArrayList<Integer>> edges, Stack<Integer> stack, boolean[] vis) {
        vis[node] = true;
    ...
    /// Convert The Edge Matrix to The Adjencency List
    
    private static ArrayList<ArrayList<Integer>> adjFacde(int V, int[][] edges) {
